...
/**
 * Classe que representa o menu principal de interação via console
 * para gerenciamento de boards (quadros de tarefas).
 */
public class MainMenu {
    ...
    /**
     * Método principal que inicia o loop do menu e processa as opções do usuário.
    ...
    /**
     * Cria um novo board com suas colunas padrão e adicionais.
     * @throws SQLException em caso de erro de acesso ao banco de dados
     */
    private void createBoard() throws SQLException {
        ...
        // Cria colunas adicionais de pendências
    ...
    /**
     * Seleciona um board existente pelo ID e abre seu menu específico.
     * @throws SQLException em caso de erro de acesso ao banco de dados
     */
    ...
    /**
     * Remove um board existente pelo ID.
     * @throws SQLException em caso de erro de acesso ao banco de dados
     */
     ...
     * @param order Ordem de exibição da coluna
     * @return Objeto BoardColumnEntity configurado
     */
